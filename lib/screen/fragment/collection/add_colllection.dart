...
import 'package:kmps/controller/collection/add_collection_controller.dart';
...
class _AddCollectionState extends State<AddCollection> {
  final addCollectionController = Get.put(AddCollectionController());
  ...
  void initState() {
    ...
    addCollectionController.getCollectionTiming();
    addCollectionController.getColletionShift();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        return addCollectionController.isLoading.value == true
            ? const Center(
